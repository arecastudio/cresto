...
<div class="lokasi">
	<a href="?ref=payment">Pelunasan</a> &rarr; Ceatak Ulang Pelunasan
</div>

<div class="judul-frame">
	<b>Cetak Ulang Pelunasan (Transaksi)</b>
</div>
...
if (isset($_POST['submit']) && $_POST['txidtrx']!='') {
  ...
  $sqli="SELECT DISTINCT
    ...
    d.produk_harga,
    d.jumlah,
    (d.produk_harga * d.jumlah) AS tot,
    d.waktu,
    d.waktu,
    d.bungkus,
    p.meja_nomor,
